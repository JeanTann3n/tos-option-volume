...
plot call_vol_01 = agg_vol(date01, strike_start, strike_end, "C");
plot call_vol_02 = agg_vol(date02, strike_start, strike_end, "C");
plot call_vol_03 = agg_vol(date03, strike_start, strike_end, "C");
plot call_vol_04 = agg_vol(date04, strike_start, strike_end, "C");
plot call_vol_05 = agg_vol(date05, strike_start, strike_end, "C");
plot call_vol_06 = agg_vol(date06, strike_start, strike_end, "C");
plot call_vol_07 = agg_vol(date07, strike_start, strike_end, "C");
plot call_vol_08 = agg_vol(date08, strike_start, strike_end, "C");
